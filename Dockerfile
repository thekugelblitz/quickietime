...
WORKDIR /app
ENV NODE_ENV=production HOSTNAME=0.0.0.0 PORT=3000 DATABASE_PATH=/app/data/quickietime.sqlite
...
EXPOSE 3000
CMD ["sh","-c","mkdir -p /app/data /app/backups && chmod 777 /app/data /app/backups 2>/dev/null || true; node scripts/validate-env.mjs && node dist/server.mjs"]
